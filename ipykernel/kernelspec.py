...
class InstallIPythonKernelSpecApp(Application):
    ...
    def start(self) -> None:
        ...
        parser.add_argument(
            ...
            type=str,
            default=KERNEL_NAME,
            help="Specify a name for the kernelspec. This is needed to have multiple IPython kernels at the same time.",
        )
        parser.add_argument(
            "--display-name",
            type=str,
            help="Specify the display name for the kernelspec. This is helpful when you have multiple IPython kernels.",
        )
        parser.add_argument(
            "--profile",
            type=str,
